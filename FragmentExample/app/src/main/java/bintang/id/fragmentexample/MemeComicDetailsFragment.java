...
public class MemeComicDetailsFragment extends Fragment {
    private static final String ARGUMENT_IMAGE_RES_ID = "imageResId";
    private static final String ARGUMENT_NAME = "name";
    private static final String ARGUMENT_DESCRIPTION = "description";
    private static final String ARGUMENT_URL = "url";

    public static MemeComicDetailsFragment newInstance(int imageResId, String name,
        ...
        final MemeComicDetailsFragment fragment = new MemeComicDetailsFragment();
        fragment.setArguments(args);
        return fragment;
    }

    public MemeComicDetailsFragment() {
    }

    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        final View view = inflater.inflate(R.layout.fragment_meme_comic_details, container, false);
